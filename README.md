...
<div align="center">
  ...
  <p align="center">
    Project of a ransomware that can roam in a wifi network to infect other machines automatically.
    <br />
...
WormsWare is simply a ransomware project to improve my python skills. WormsWare provides unbreakable encryption thanks to:
* RSA
* FERNET KEY
* PKCS1_OAEP
